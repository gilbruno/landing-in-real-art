...
const useSharedLogicRegistrationNewsletter = () => {
      ...
      if (validateEmail(email)) {
          ...
          try {
            ...
            if (msgError !== '') {
              ...
              toast({
                title: 'Congrats ! Registration for the newsletter successful.',
                description: '',
                status: 'success',
                duration: 3000,
                isClosable: true,
...
export default useSharedLogicRegistrationNewsletter