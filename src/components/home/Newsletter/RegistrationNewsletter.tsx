...
import useSharedLogicRegistrationTestnet from "./useSharedLogicRegistrationNewsletter";
import { IoSend } from "react-icons/io5";
import { useEffect, useState } from "react";
import SimpleCaptcha from "@/components/common/Captcha/SimpleCaptcha";
import styles from './RegistrationNewsletter.module.scss'

const RegistrationNewsletter: React.FC<ModalProps> = ({
  title,
  description,
  showModal,
  setShowModal,
