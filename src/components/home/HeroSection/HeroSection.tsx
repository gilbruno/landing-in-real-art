...
const HeroSection = () => {
  ...
  const { headerButtons, setHeaderButtons, headerTexts, setHeaderTexts } =
    useSharedLogicHeroSection(FIREBASE_HEADER_COLLECTION);
          ...
          <div className={styles.heroSectionTitle}>
            <div className={styles.heroSectionHeading}>
              <span>
                ...
                <span className={styles.heroSectionHeadingSpan2}>
          ...
          <div className={styles.heroSectionContainerButton}>
            <Link href={headerButtons.button1Link}>
              <div className={styles.heroSectionButton}>
                <div className={styles.heroSectionRejoindreIra}>
            ...
            <Link href={headerButtons.button2Link}>
              <div className={styles.heroSectionButton}>
                <div className={styles.heroSectionJeDemarre}>
