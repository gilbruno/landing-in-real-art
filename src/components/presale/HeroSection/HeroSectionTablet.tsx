...
const HeroSectionTablet = () => {
  ...
  const { presaleButtons, setPresaleButtons, presaleTexts, setPresaleTexts } =
    ...
    <div className={styles["heroSectionContainer"]}>
      <div className={styles["heroSectionContainer1"]}>
        <div className={styles["heroSectionTopTitle"]}>
          <p>
            <span className={styles["heroSectionTopTitle1"]}>
              {" "}
              {presaleTexts.title1[lang_]}{" "}
            </span>
            <span className={styles["heroSectionTopTitle2"]}>
              {presaleTexts.title2[lang_]}
            </span>
          </p>
        </div>
      ...
      <div className={styles["heroSectionContainer2"]}>
        ...
        <div className={styles["heroSectionContainer3"]}>
          <div className={styles["div-wrapper"]}>
            <p className={styles["p"]}>{presaleTexts.description[lang_]}</p>
          </div>
          <Link
            href={presaleButtons[FIREBASE_PRESALE_HERO_SECTION_SEE_DROP_LINK]}
          >
