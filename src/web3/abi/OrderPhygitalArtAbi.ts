    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct BuyerToRefund",
        "components": [
          {
            "name": "buyer",
            "type": "address",
